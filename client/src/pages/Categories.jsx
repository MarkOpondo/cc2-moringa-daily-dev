...
export default function Categories() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs font-mono text-amber-500 mb-1">// categories</p>
        <h1 className="text-2xl font-bold text-white">Subscribe to what you care about</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {categories.map((cat) => {
          ...
          return (
            <div key={cat.id} className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col gap-3">
