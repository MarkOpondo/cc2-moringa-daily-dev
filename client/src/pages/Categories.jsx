  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-cream">Subscribe to what you care about</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {categories.map((cat) => {
          ...
          return (
            <div key={cat.id} className="p-4 rounded-xl border border-navy-border bg-navy flex flex-col gap-3">
              <div className="flex items-start justify-between">
                ...
                <button
                  onClick={() => dispatch(toggleCategorySubscription({ categoryId: cat.id, subscribed }))}
