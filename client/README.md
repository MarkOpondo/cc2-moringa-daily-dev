...
The development entry point applies pending migrations before serving requests. The API listens on `http://localhost:5001` by default. To migrate an existing database without starting the server, run:
